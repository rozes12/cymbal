      ...
      <div className="flex flex-col min-h-screen">
        ...
        <main className="flex-grow">
          <Routes>
            ...
            {/* Existing route for Category Section Page (manual prompting) */}
            <Route path="/admin/category-section" element={<CategorySectionPage />} />
            {/* NEW ROUTE for Category Section Page from Image (with image data) */}
            <Route path="/admin/category-section-from-image" element={<CategorySectionPage />} />
          </Routes>
        </main>
        <Footer />
      </div>
