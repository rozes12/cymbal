...
export default function AIGenerationPage() {
  ...
  return (
    <div className="p-8 flex-grow">
      ...
      {activeTab === 'generate' && (
        <div className="mb-4">
          <h3 className="text-2xl font-bold mb-4">Product Generation Tools</h3>
          <div className="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-4">
            <Link to="/admin/category-section-from-image"> {/* Note: This route is NOT nested */}
              <Button className="w-full sm:w-auto">Attribute Generation Prompting</Button>
            </Link>
            <Link to="/admin/image-editor"> {/* Note: This route is NOT nested */}
      ...
      {activeTab === 'approvals' && (
        <>
          <h3 className="text-2xl font-bold mb-4">Pending Product Approvals</h3>
